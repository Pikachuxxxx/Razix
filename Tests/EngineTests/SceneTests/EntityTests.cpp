...
// Note: RZEntity may have dependencies that require proper setup
...
namespace Razix {
        ...
        TEST_F(EntityTests, BasicAPIExistence)
        {
        ...
        TEST_F(EntityTests, HeaderInclusion)
        {
            // Test that header can be included without errors
            SUCCEED() << "RZEntity.h header should be includable without compilation errors.";
        }

        // Test case for namespace organization
        TEST_F(EntityTests, NamespaceOrganization)
        {
        ...
        TEST_F(EntityTests, APIDesignConsistency)
        {
        ...
        TEST_F(EntityTests, BasicInstantiationConcepts)
        {
