...
// Note: RZShader may have dependencies that require proper setup
...
namespace Razix {
        ...
        TEST_F(ShaderTests, BasicAPIExistence)
        {
        ...
        TEST_F(ShaderTests, HeaderInclusion)
        {
            // Test that header can be included without errors
            SUCCEED() << "RZShader.h header should be includable without compilation errors.";
        }

        // Test case for namespace organization
        TEST_F(ShaderTests, NamespaceOrganization)
        {
        ...
        TEST_F(ShaderTests, APIDesignConsistency)
        {
        ...
        TEST_F(ShaderTests, BasicInstantiationConcepts)
        {
