...
namespace UnitTests {
    ...
    [TestFixture] public ref class TestDllImports
    {
    public:
        [Test] static void TestSendMessage() {
            ...
            [Test] static void TestPostMessage()
        {
            array<Type ^> ^ params = gcnew array<Type ^>(4);
            params[0]              = IntPtr::typeid;
        ...
        [Test] static void TestSetWindowsHookEx() {
            array<Type ^> ^ params = gcnew array<Type ^>(4);
            ...
            [Test] static void TestCopyMemory()
        {
