...
namespace UnitTests {
    ...
    [TestFixture] public ref class TestMarshaledStructs
    {
    public:
        [Test] static void TestSHFILEINFO() {
            ...
            [Test] static void TestBROWSEINFO()
        {
        ...
        [Test] static void TestBROWSEINFOW() {
            BROWSEINFOW nativeInfo;
            ...
            [Test] static void TestMEMORYSTATUSEX()
        {
        ...
        [Test] static void TestBITMAP() {
            ...
            [Test] static void TestBITMAPINFO_FLAT()
        {
        ...
        [Test] static void TestBITMAPINFOHEADER() {
            ::BITMAPINFOHEADER                               nativeInfo;
        ...
        [Test] static void TestMINMAXINFO() {
        ...
        [Test] static void TestTRACKMOUSEEVENT() {
        ...
        [Test] static void TestWINDOWPOS() {
            ...
            [Test] static void TestNCCALCSIZE_PARAMS()
        {
        ...
        [Test] static void TestWINDOWINFO() {
            ...
            [Test] static void TestOPENFILENAME()
        {
        ...
        [Test] static void TestDROPDESCRIPTION() {
            ...
            [Test] static void TestShDragImage()
        {
...
#ifdef _M_IX86
            [Test] static void TestDDCOLORKEY()
        {
...
#ifdef _M_IX86
        [Test] static void TestDDPIXELFORMAT() {
...
#ifdef _M_IX86
            [Test] static void TestDDSURFACEDESC2()
        {
