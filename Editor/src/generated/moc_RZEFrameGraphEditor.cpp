...
QT_MOC_LITERAL(6, 90, 20), // "OnAddInputPinClicked"
QT_MOC_LITERAL(7, 111, 21), // "OnInputPinNameChanged"
QT_MOC_LITERAL(8, 133, 3), // "idx"
QT_MOC_LITERAL(9, 137, 23), // "OnRemoveInputPinClicked"
QT_MOC_LITERAL(10, 161, 21), // "OnAddOutputPinClicked"
QT_MOC_LITERAL(11, 183, 22), // "OnOutputPinNameChanged"
QT_MOC_LITERAL(12, 206, 24) // "OnRemoveOutputPinClicked"
...
void Razix::Editor::RZEFrameGraphEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->OnAddInputPinClicked(); break;
        case 3: _t->OnInputPinNameChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->OnRemoveInputPinClicked(); break;
        case 5: _t->OnAddOutputPinClicked(); break;
        case 6: _t->OnOutputPinNameChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: _t->OnRemoveOutputPinClicked(); break;
        default: ;
        }
    }
}
