...
namespace tracy {
    ...
    Socket::Socket()
        : m_buf((char*) tracy_malloc(BufSize)), m_bufPtr(nullptr), m_sock(-1), m_bufLeft(0), m_ptr(nullptr)
    {
#ifdef _WIN32
        InitWinSock();
#endif
    ...
    Socket::Socket(int sock)
        : m_buf((char*) tracy_malloc(BufSize)), m_bufPtr(nullptr), m_sock(sock), m_bufLeft(0), m_ptr(nullptr)
    {
    }
