...
namespace tracy {
    ...
    SourceView::SourceView(ImFont* font, GetWindowCallback gwcb)
        : m_font(font), m_symAddr(0), m_targetAddr(0), m_targetLine(0), m_selectedLine(0), m_asmSelected(-1), m_hoveredLine(0), m_hoveredSource(0), m_codeLen(0), m_highlightAddr(0), m_asmCountBase(-1), m_asmRelative(false), m_asmBytes(false), m_asmShowSourceLocation(true), m_calcInlineStats(true), m_atnt(false), m_childCalls(false), m_showJumps(true), m_cpuArch(CpuArchUnknown), m_showLatency(false), m_gwcb(gwcb)
    {
    ...
    static bool IsJumpConditionalX86(const char* op)
    {
        static constexpr const char* branchX86[] = {
            "je", "jne", "jg", "jge", "ja", "jae", "jl", "jle", "jb", "jbe", "jo", "jno", "jz", "jnz", "js", "jns", "jcxz", "jecxz", "jrcxz", "loop", "loope", "loopne", "loopnz", "loopz", "jnle", "jnl", "jnge", "jng", "jnbe", "jnb", "jnae", "jna", "jc", "jnc", "jp", "jpe", "jnp", "jpo", nullptr};
        auto ptr = branchX86;
        while (*ptr)
