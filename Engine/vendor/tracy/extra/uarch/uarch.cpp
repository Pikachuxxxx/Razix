        ...
        for (auto& op: ext) {
            ...
            for (auto& param: op.children("operand")) {
                if (!param.attribute("suppressed")) {
                    ...
                    else if (strcmp(param.attribute("type").value(), "reg") == 0)
                        type = 1;
                    else if (strcmp(param.attribute("type").value(), "mem") == 0)
                        type = 2;
                    else if (strcmp(param.attribute("type").value(), "agen") == 0)
                        type = 2;
            ...
            for (auto& ua: op.children("architecture")) {
                ...
                if (measurement) {
                    ...
                    else if (measurement.attribute("TP_ports"))
                        tp = atof(measurement.attribute("TP_ports").value());
                    else if (measurement.attribute("TP_unrolled"))
                        tp = atof(measurement.attribute("TP_unrolled").value());
