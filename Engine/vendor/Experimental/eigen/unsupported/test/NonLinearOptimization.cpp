...
void testChkder()
{
    ...
    err_ref << 0.1141397, 0.09943516, 0.09674474,
...
void testHybrj1()
{
    ...
    // check x
    VectorXd x_ref(n);
    x_ref << -0.5706545, -0.6816283, -0.7017325,
