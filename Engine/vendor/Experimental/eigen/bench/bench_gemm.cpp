...
void blas_gemm(const A& a, const B& b, MatrixXf& c)
{
    ...
    sgemm_(&transA, &transB, &M, &N, &K, &fone, const_cast<float*>(a.data()), &lda, const_cast<float*>(b.data()), &ldb, &fone, c.data(), &ldc);
}
...
void blas_gemm(const A& a, const B& b, MatrixXd& c)
{
    ...
    dgemm_(&transA, &transB, &M, &N, &K, &done, const_cast<double*>(a.data()), &lda, const_cast<double*>(b.data()), &ldb, &done, c.data(), &ldc);
}
...
void blas_gemm(const A& a, const B& b, MatrixXcf& c)
{
    ...
    cgemm_(&transA, &transB, &M, &N, &K, (float*) &cfone, const_cast<float*>((const float*) a.data()), &lda, const_cast<float*>((const float*) b.data()), &ldb, (float*) &cfone, (float*) c.data(), &ldc);
}
...
void blas_gemm(const A& a, const B& b, MatrixXcd& c)
{
    ...
    zgemm_(&transA, &transB, &M, &N, &K, (double*) &cdone, const_cast<double*>((const double*) a.data()), &lda, const_cast<double*>((const double*) b.data()), &ldb, (double*) &cdone, (double*) c.data(), &ldc);
}
