...
namespace ImGui
{
    ...
    //static inline void  SetNextFrameWantCaptureMouse(bool want_capture_mouse = true)                         { SetNextFrameWantCaptureMouse(want_capture_mouse); }       // Renamed as name was misleading + removed default value.
