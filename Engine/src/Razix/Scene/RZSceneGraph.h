...
extern "C"
{
    ...
    // Lifecycle
    RAZIX_API rz_scene_graph* rz_scene_graph_create();
    RAZIX_API rz_scene_graph* rz_scene_graph_create_from_file(const void* pFileData, u64 fileSize);
    ...
    RAZIX_API i32 rz_scene_graph_create_node(rz_scene_graph* sg, struct rz_asset_db* pAssetDb, i32 parentNodeIdx, const char* name, rz_uuid uuid, Razix::RZAssetType type);
    ...
    RAZIX_API rz_scene_graph_manager* rz_scene_graph_manager_create();
