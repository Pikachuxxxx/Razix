...
namespace Razix {
    namespace Gfx {
        ...
        RAZIX_API void BeginMarker(rz_gfx_cmdbuf_handle cmdBufHandle, const RZString& name, const glm::vec4& color);
        RAZIX_API void InsertMarker(rz_gfx_cmdbuf_handle cmdBufHandle, const RZString& name, const glm::vec4& color);
