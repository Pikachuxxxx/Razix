...
namespace Razix {
    namespace Gfx {
        ...
        struct FramebufferInfo
        {
            ...
            Gfx::RZRenderPass* renderPass; /* The render passes that will performed on the contents of the framebuffer             */
            // TODO: resolve this from the render pass that is provided
            //TextureType*        attachmentTypes;        /* The types of the attachments                                                         */
        };
