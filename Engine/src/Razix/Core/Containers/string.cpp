...
namespace Razix {
    ...
    i32 rz_strcmp(const char* s1, const char* s2)
    {
    ...
    i32 rz_memcmp(const void* ptr1, const void* ptr2, sz count)
    {
    ...
    RZString::RZString(const char* str)
    {
        ...
        if (len < RAZIX_SSO_STRING_SIZE) {
            ...
            m_capacity = len + 1;
            m_data.ptr = static_cast<char*>(RZ_MALLOC_ALIGNED(len + 1, RAZIX_CACHE_LINE_ALIGN));
    ...
    RZString::RZString(const char* str, sz count)
    {
        ...
        if (count < RAZIX_SSO_STRING_SIZE) {
            ...
            m_capacity = count + 1;
            m_data.ptr = static_cast<char*>(RZ_MALLOC_ALIGNED(count + 1, RAZIX_CACHE_LINE_ALIGN));
    ...
    void RZString::reserve(sz new_capacity)
    {
        ...
        char* new_buf = (char*) RZ_MALLOC_ALIGNED(m_capacity + 1, RAZIX_CACHE_LINE_ALIGN);
