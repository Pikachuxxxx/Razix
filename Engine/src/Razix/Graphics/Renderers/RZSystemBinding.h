...
enum BindingTable_System : u32
{
    ...
    BINDING_IDX_GLOBAL_BINDLESS_TEXTURES_3D_BINDING_IDX      = BINDING_IDX_BINDLESS_RESOURCES_START,
    BINDING_IDX_GLOBAL_BINDLESS_TEXTURES_CUBEMAP_BINDING_IDX = BINDING_IDX_BINDLESS_RESOURCES_START,
