...
namespace Razix
{
    namespace Graphics
    {
        ...
        RZDeferredRenderer::~RZDeferredRenderer()
        {
        ...
        void RZDeferredRenderer::Init()
        {
            RAZIX_PROFILE_FUNCTION();
            m_OffScreenRenderer = new RZDeferredOffScreenRenderer(m_ScreenBufferWidth, m_ScreenBufferHeight);
        ...
        void RZDeferredRenderer::RenderScene()
        {
            RAZIX_PROFILE_FUNCTION();
        ...
        void RZDeferredRenderer::PresentToScreen()
        {
            RAZIX_PROFILE_FUNCTION();
            //Renderer::Present(Renderer::GetSwapchain()->GetCurrentCommandBuffer());
        }

        void RZDeferredRenderer::Begin(int commandBufferID)
        {
            RAZIX_PROFILE_FUNCTION();
        ...
        void RZDeferredRenderer::BeginScene(Scene* scene, Camera* overrideCamera, Maths::Transform* overrideCameraTransform)
        {
            RAZIX_PROFILE_FUNCTION();
        ...
        void RZDeferredRenderer::Submit(const RenderCommand& command)
        {
            RAZIX_PROFILE_FUNCTION();
            m_CommandQueue.push_back(command);
        }

        void RZDeferredRenderer::SubmitMesh(Mesh* mesh, Material* material, const Maths::Matrix4& transform, const Maths::Matrix4& textureMatrix)
        {
            RAZIX_PROFILE_FUNCTION();
        ...
        void RZDeferredRenderer::SubmitLightSetup(Scene* scene)
        {
            RAZIX_PROFILE_FUNCTION();
            ...
            if(shadowRenderer)
            {
                ...
                Razix::Maths::Vector4* uSplitDepth = shadowRenderer->GetSplitDepths();
        ...
        void RZDeferredRenderer::CreateDeferredPipeline()
        {
            RAZIX_PROFILE_FUNCTION();
        ...
        void RZDeferredRenderer::SetRenderTarget(Texture* texture, bool rebuildFramebuffer)
        {
            RAZIX_PROFILE_FUNCTION();
        ...
        void RZDeferredRenderer::OnImGui()
        {
            RAZIX_PROFILE_FUNCTION();
        ...
        void RZDeferredRenderer::CreateLightBuffer()
        {
        ...
        void RZDeferredRenderer::UpdateScreenDescriptorSet()
        {
            std::vector<Graphics::Descriptor> bufferInfos;
