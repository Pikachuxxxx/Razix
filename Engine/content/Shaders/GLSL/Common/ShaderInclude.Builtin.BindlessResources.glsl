...
#ifndef SET_IDX_USER_DATA_START
    #define SET_IDX_USER_DATA_START          4
    #define SET_IDX_USER_DATA_SLOT_0         SET_IDX_USER_DATA_START
    #define SET_IDX_USER_DATA_SLOT_1         SET_IDX_USER_DATA_START + 1
    #define SET_IDX_USER_DATA_SLOT_2         SET_IDX_USER_DATA_START + 2
    #define SET_IDX_USER_DATA_SLOT_3         SET_IDX_USER_DATA_START + 3
    #define SET_IDX_USER_DATA_SLOT_4         SET_IDX_USER_DATA_START + 4
#endif
